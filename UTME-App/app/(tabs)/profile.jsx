...
//               className="w-24 h-24 rounded-2xl border-2 border-white shadow-md bg-white"
//               resizeMode="cover"
//             />
//             <TouchableOpacity 
//               activeOpacity={0.8}
//               className="absolute -bottom-2 -right-2 w-8 h-8 bg-green-600 rounded-xl justify-center items-center border-2 border-white shadow-sm"
//             >
...
//                 </View>
//                 <Text className="text-sm font-semibold text-gray-800">Edit Profile Information</Text>
//               </View>
...
//                 </View>
//                 <Text className="text-sm font-semibold text-gray-800">Change Password</Text>
//               </View>
//               <Ionicons name="chevron-forward" size={18} color="#9ca3af" />
//             </TouchableOpacity>
...
//                 </View>
//                 <Text className="text-sm font-semibold text-gray-800">Help & Support</Text>
//               </View>
//               <Ionicons name="chevron-forward" size={18} color="#9ca3af" />
//             </TouchableOpacity>
