...
//             <View className="flex-row items-center opacity-40">
//               <Ionicons name="close-circle" size={18} color="#dc2626" style={{ marginRight: 10 }} />
//               <Text className="text-sm font-medium text-gray-400 line-through">Detailed performance analytics</Text>
//             </View>
//           </View>
//         </View>
...
//             <View className="flex-row items-center">
//               <Ionicons name="checkmark-circle" size={18} color="#16a34a" style={{ marginRight: 10 }} />
//               <Text className="text-sm font-semibold text-gray-800">Subject-by-subject percentage breakdowns</Text>
//             </View>
//             <View className="flex-row items-center">
//               <Ionicons name="checkmark-circle" size={18} color="#16a34a" style={{ marginRight: 10 }} />
